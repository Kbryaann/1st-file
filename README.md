...
xt.exchanges = [{
    ...
    iconComponent: e=>{
        ...
        n = r.nextSibling,
        ie(t, e, !0, !0),
        r.style.setProperty("stop-color", "#264CA2"),
...
function wr() {
    ...
    mr(`data/bubbles1000.${t.id}.json`, e).then((e=>{
        ...
        (null == e ? void 0 : e.signal.aborted) || (cr("loading-failed"),
        pr((()=>Et())))
    }
    ))
}
...
function Br(e) {
    return (t = Lr()).$$click = ()=>xr.logAction("CLICK_LINK", e.name),
    ae(t, (()=>e.children)),
    m((r=>{
        var n = e.href
          , i = e.title
...
var Dr = Q("<button>");
function Nr(e) {
    return (t = Dr()).$$click = t=>e.onClick(t),
    ae(t, (()=>e.children)),
    m((r=>{
        var n = Er("icon-button", e.active && "active", e.hidden && "hidden", e.class)
          , i = e.title
          , o = e.hidden ? -1 : void 0;
...
function Vr() {
    ...
    ;
    return (r = Or()).addEventListener("animationiteration", t),
    r;
    var r
}
...
function tn(e) {
    ...
    return V(fe, {
        get children() {
            var t = en();
            return "function" == typeof n ? oe(n, t) : n = t,
            ae(t, (()=>e.children)),
            m((r=>{
...
var nn = Q("<button>");
function on(e) {
    return (t = nn()).$$click = t=>e.onClick(t),
    ae(t, (()=>e.children)),
    m((r=>{
...
function ln(e) {
    return ae((t = an()).firstChild, (()=>e.label)),
    ae(t, V(j, {
        get each() {
            return e.options
        },
                    ...
                    get fallback() {
                        return ae(t = cn(), V(j, {
                            ...
                            children: e=>{
                                ...
                                ae(r, (()=>e.label)),
                                m((()=>re(t, Er("menu-item", JSON.stringify(e.value) === i() && "selected")))),
                                t;
                                var t, r
                            }
                        })),
...
function Fn(e) {
    ...
    ae(n, (()=>e.content)),
    m((r=>{
        var i = Er(e.solid ? "solid-button" : "icon-button", t() && "active", e.class)
          , o = e.title;
        return i !== r.e && re(n, r.e = i),
...
function Un(e) {
    ...
    return (()=>{
        ...
        return "function" == typeof n ? oe(n, i) : n = i,
        ae(r, V(U, {
            get children() {
                return [V(W, {
                    get when() {
...
function Xn() {
    return V(dn, {
        ...
        get children() {
            return [{
                label: "Fiat",
                options: Mt.baseCurrencies.filter((e=>!Wn[e.code])).map((e=>({
                    value: e,
...
function ri(e) {
    return (t = ti()).$$click = e=>e.stopImmediatePropagation(),
    ae(t, (()=>e.children)),
    t;
    var t
}
    ...
    return V(ri, {
        get children() {
            return [ni(), V(Un, {
                ...
                get fallback() {
                    return ae(t = ii(), (()=>"" === e() ? "Data is empty" : "Data is invalid")),
                    t;
                    var t
                },
                children: e=>{
                ...
                children: (e,t)=>{
                    ...
                    ae(r, V(En, {
                        onDelete: ()=>function(e) {
                            ...
                            Ot((t=>"list" === t.type && "watch" === t.list[0] && t.list[1] === e.id ? Mt.sliceFilters[0] : t))
                        }(e)
                    }), null),
                    r;
                    var r
...
function zi(e) {
    ...
    m((n=>{
        var i = Er("flex-row gap-m", e.class)
          , o = e.currency.image
          , a = e.currency.name
          , l = `Logo of ${e.currency.name}`;
        return i !== n.e && re(t, n.e = i),
        o !== n.t && te(r, "src", n.t = o),
...
const {filteredCurrencies: Ai, selectedConfiguration: Pi, selectedCurrency: Ti, searchResults: $i} = f((()=>({
    filteredCurrencies: y((()=>{
        ...
        const e = Nt()
          , t = Li(e);
        let r = t;
        return "list" !== e.type && (r = er() ? e=>!e.stable && !Si(e) && t(e) : e=>!Si(e) && t(e)),
        rr.filter(r)
    }
    )),
    ...
    searchResults: ()=>{
        const e = gr().trim().toUpperCase()
          , t = [];
        for (const r of rr)
            if (kn(r) && (r.nameUpper.includes(e) || r.symbol.includes(e)) && (t.push(r),
            10 === t.length))
                break;
        return t
    }
        ...
        get children() {
            ...
            ae(t, V(j, {
                ...
                children: (t,r)=>{
                    ...
                    ae(o, (()=>t.symbol)),
                    m((()=>re(n, Er("menu-item", r() === e.focusIndex && "focused")))),
                    n;
                    var n, i, o
                }
            })),
...
function qi() {
    ...
    ae(i, V(Vr, {}), null),
    m((e=>{
        var t = Er("header flex-row gap-m", r() && "mobile-search-open")
          , n = Mt.logo
          , a = Mt.app
          , l = `Logo of ${Mt.app}`;
        return t !== e.e && re(i, e.e = t),
        n !== e.t && te(o, "src", e.t = n),
        a !== e.a && te(o, "alt", e.a = a),
        l !== e.o && te(o, "title", e.o = l),
        e
    }
    ), {
        e: void 0,
...
function io() {
    ...
    ae(r, V(I, {
        ...
        get fallback() {
            return (e = ro()).firstChild,
            ae(e, "2024-3-5-20-13", null),
            e;
            var e
        },
        children: e=>V(Un, {
                ...
                get content() {
                    return [V(Nn, {}), V(j, {
                        get each() {
                            return (()=>{
                                const t = [];
                                Si(e.currency) && t.push(pn),
                                fo(e.currency) && t.push(fn);
                                for (const r of Jt)
                ...
                get children() {
                    ...
                    return ae(t, V(j, {
                        ...
                        children: t=>{
                            ...
                            m((()=>re(r, Er("menu-item", Bi(e.currency, t.record) && "selected")))),
                            r;
                            var r, n
                        }
                    })),
                        ...
                        children: t=>V(I, {
                            ...
                            get fallback() {
                                return V(I, {
                                    ...
                                    get children() {
                                        var e = Lo();
                                        return e.style.setProperty("width", "24px"),
                                        e
                                    }
                                })
                            },
                    ...
                    return V(j, {
                        ...
                        children: e=>V(I, {
                            ...
                            children: r=>V(Br, {
                                ...
                                get children() {
                                    return [V(e.exchange.iconComponent, {}), (t = Bo(),
                                    ae(t, (()=>e.exchange.name)),
                                    t), V(qr, {})];
                                    var t
                                }
                            })
...
function Uo(e) {
    function t(e) {
        return ae(t = jo(), (()=>go(e))),
        m((()=>null != $o(e, jt()) ? t.style.setProperty("background-color", $o(e, jt())) : t.style.removeProperty("background-color"))),
        t;
        var t
    }
    return r = Io(),
...
const Xo = e=>{
    return ie(t = Wo(), e, !0, !0),
    t;
    var t
}
;
var Go = Q("<div class=scroll-container><table><thead><tr><th></th></tr></thead><tbody>")
  , qo = Q("<th><div><span>");
const Yo = [{
    label: ()=>"#",
...
function Zo(e) {
    ...
    ae(f, V(j, {
        ...
        children: e=>{
            ...
            n = r.firstChild,
            t.$$click = ()=>function(e) {
                dr((t=>t && t.column === e ? "asc" === t.direction ? null : {
                    ...t,
                    direction: "asc"
                } : {
                    column: e,
            ...
            ae(n, (()=>e.label())),
            m((n=>{
                var i, o = Er("sortable", l(e) && `sorted-${null == (i = ur()) ? void 0 : i.direction}`), a = Er("flex-row", e.class);
...
class va {
    ...
    rerender(e) {
        ...
        if (i !== this.lastFingerprint) {
            ...
            if (o.addColorStop(0, `rgba(${this.color}, 0.05)`),
            o.addColorStop(.8, `rgba(${this.color}, 0.1)`),
            o.addColorStop(.9, `rgba(${this.color}, 0.4)`),
            o.addColorStop(1, `rgb(${this.color})`),
            this.canvas.circle(r, r, r),
            this.canvas.fill(o),
            n) {
                const e = "red-green" === jt() ? "yellow" : "#f4a";
                this.canvas.circle(r, r, r),
                this.canvas.stroke(e, Mt.bubbleBorder)
            }
            const a = r > 30
              , l = r * (a ? .55 : 1.2)
...
class ba extends ma {
    ...
    recalculcate() {
        ...
        for (const d of this.bubbles) {
            ...
            if (d.size = r ? sa(d.currency, e, n) : 0,
            d.size > 0) {
                l += d.size;
...
function wa() {
    ...
    ;
    return _((()=>{
        if (window.addEventListener("focus", o),
    ...
    (()=>{
        ...
        return "function" == typeof t ? oe(t, n) : t = n,
        r
    }
    )()
}
...
function La(e) {
    ...
    (()=>{
        ...
        m((t=>{
            ...
            return i !== t.e && re(n, t.e = i),
            o !== t.t && (null != (t.t = o) ? n.style.setProperty("border-color", o) : n.style.removeProperty("border-color")),
            t
        }
        ), {
            e: void 0,
...
class Fa extends ma {
    ...
    render() {
        ...
        if (this.clear(),
        null === t || null === r || null === e || 0 === e.length)
            return;
...
function Ea(e) {
    ...
    return _((()=>{
        t && (r = new Fa(t),
        r.start()),
        xr.eventUpdateData.register(l)
    }
    )),
    k((()=>{
        r && r.stop(),
        xr.eventUpdateData.unregister(l),
        a()
    }
    )),
    b((()=>{
                ...
                get children() {
                    ...
                    ae(t, V(j, {
                        ...
                        children: t=>{
                            ...
                            ae(l, (()=>go(i(), !0))),
                            m((e=>{
                                var n = Er("flex-column grow", t === r() && "selected")
                                  , a = (()=>{
                                    const e = To(i(), jt())
                                      , t = $o(i(), jt());
        ...
        get children() {
            return [V(W, {
                ...
                get children() {
                    var e = Ka()
                      , t = e.firstChild;
                    return ae(t.nextSibling, (()=>Vt().loading)),
                    m((e=>{
                        var r = Mt.logo
                          , n = Mt.app
                          , i = `Logo of ${Mt.app}`;
...
function rl() {
    return b((()=>At.save(At.generateSave()))),
    b((()=>wr())),
    b((()=>{
        const e = Ma(Pi())
          , t = To(e, jt())
...
ee(["click"]);
const nl = window.matchMedia("(display-mode: standalone)").matches
  , il = document.getElementById("app")
...
window.addEventListener("load", (()=>{
    ...
    "ios" !== xr.env && "serviceWorker"in navigator && navigator.serviceWorker.register("./sw.js")
}
));
